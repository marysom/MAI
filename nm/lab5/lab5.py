...
img1 = ImageTk.PhotoImage(Image.open('pic1lab5.bmp'))
...
img2 = ImageTk.PhotoImage(Image.open('pic2lab5.bmp'))
panel2 = Label(root, image = img2)
panel2.place(x = 10, y = 220)

label3 = Label(text = "Аналитическое решение:", justify = LEFT, font = "Arial 12")
label3.place(x = 10, y = 410)
img3 = ImageTk.PhotoImage(Image.open('pic3lab5.bmp'))
panel3 = Label(root, image = img3)
panel3.place(x = 10, y = 440)
